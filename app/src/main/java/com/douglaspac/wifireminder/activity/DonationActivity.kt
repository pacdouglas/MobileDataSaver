...
class DonationActivity : AppCompatActivity() {
    companion object {
        private val GOOGLE_CATALOG: ArrayList<String> = TODO("Create products on Google Play Console")
        private val GOOGLE_PUBKEY: String = TODO("Get on your Google Play Console")
    ...
    private val mValuesAvailable by lazy {
        ...
        mutableMapOf<String, String>().apply {
            GOOGLE_CATALOG.forEachIndexed { index, s -> this[s] = valuesDefault[index] }
        }
    }
